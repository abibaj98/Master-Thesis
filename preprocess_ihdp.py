...
ihdp_train = load("ihdp/ihdp_npci_1-100.train.npz")
files_train = ihdp_train.files

# load 100 realisations of IHDP test set (72 units)
ihdp_test = load('ihdp/ihdp_npci_1-100.test.npz')
...
np.save('ihdp/ihdp_train_processed', ihdp_train_processed)
...
np.save('ihdp/ihdp_test_processed', ihdp_test_processed)
